...
## [0.6.1](https://github.com/gseg-ethz/GSEGUtils/compare/v0.6.0...v0.6.1) (2026-09-23)
...
* remove the deprecation canary, capture the drift report, log the anti-skip pass ([#80](https://github.com/gseg-ethz/GSEGUtils/issues/80)) ([d26d754](https://github.com/gseg-ethz/GSEGUtils/commit/d26d75407d961c39b347214892991b00b2c57f77))
* **rulesets:** record the unattributed-changes approval parameter ([#78](https://github.com/gseg-ethz/GSEGUtils/issues/78)) ([40beef2](https://github.com/gseg-ethz/GSEGUtils/commit/40beef2c7a10c3b62dce0773193d346390a58339))
...
* **RTD version-label override:** `docs/source/conf.py` shipped with `version = "1.0.1"` at the
  ...
  to `0.5.0` on 2026-06-12 (UTC); the displayed label in the version selector now reads `0.5`.
  The config is fixed in commit
